package com.tchokoapps.springboot.kafka.kafkerorder.services;
...
import com.tchokoapps.springboot.kafka.kafkerorder.kafka.messages.OrderItemKafkaMessage;
import com.tchokoapps.springboot.kafka.kafkerorder.kafka.messages.OrderKafkaMessage;
import com.tchokoapps.springboot.kafka.kafkerorder.kafka.producers.OrderProducer;
import com.tchokoapps.springboot.kafka.kafkerorder.repositories.OrderRepository;
...
public class OrderService {
    ...
    public Order saveOrder(OrderDtoRequest orderDtoRequest) {
        ...
        orderKafkaMessage.setOrderItemKafkaMessages(orderItemKafkaMessages);
